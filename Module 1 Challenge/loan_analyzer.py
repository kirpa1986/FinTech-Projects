...
print(f"Working with the following loans: {loan_costs}")
...
# YOUR CODE HERE!
average_loan_price = total_of_loans / num_of_loans
print(f"The average of all loans equals to ${average_loan_price:.2f}")
...
print(f"The future value of the loan is ${future_value}\nThere are {remaining_months} months to payout the loan")
...
if present_value >= loan_price:
    print(f"The current cost of loan (${loan_price}) is less than the fair value of the loan (${present_value:.2f}). This loan is worth the cost to buy it")
else:
    print(f"The cost of loan (${loan_price}) is higher than the fair value of the loan (${present_value:.2f}). This loan is too expensive and not worth the price")
...
present_value = present_value_calc(new_loan.get("future_value"), new_loan.get("remaining_months"), annual_discount_rate)
...
write_inexpensive_loan_values(inexpensive_loans, output_path, header, withDictWriter=False)